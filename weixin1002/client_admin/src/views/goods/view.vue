		...
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" v-show="!form.source_table" style="text-align: center;" class="el_form_btn_warp">
				...
				<el-button @click="cancel()">取消</el-button>
					...
					<!-- 菜品信息 -->
			<diy_dish_information v-if="form.source_table === 'dish_information'" :query="{dish_information_id:form.source_id}" :form_goods="form" :func_check="checkForm" :func_submit="submit" ></diy_dish_information>
...
<script>
	import mixin from "../../mixins/page.js";
			import diy_dish_information from "../../components/diy/diy_dish_information.vue";
													
	export default {
		mixins: [mixin],
		components:{
					diy_dish_information,
															},
		data() {
			return {
				field: "goods_id",
