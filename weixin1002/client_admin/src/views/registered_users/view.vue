		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户编号" prop="user_number">
												<el-input id="user_number" v-model="form_sub['user_number']" placeholder="请输入用户编号"
							  v-if="user_group === '管理员' || (form_sub['registered_users_id'] && $check_field('set','user_number')) || (!form_sub['registered_users_id'] && $check_field('add','user_number'))"></el-input>
					<div v-else-if="$check_field('get','user_number')">{{form_sub['user_number']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="姓名" prop="full_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['registered_users_id'] && $check_field('set','full_name')) || (!form_sub['registered_users_id'] && $check_field('add','full_name'))"></el-input>
