		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="员工编号" prop="employee_id">
												<el-input id="employee_id" v-model="form_sub['employee_id']" placeholder="请输入员工编号"
							  v-if="user_group === '管理员' || (form_sub['staff_id'] && $check_field('set','employee_id')) || (!form_sub['staff_id'] && $check_field('add','employee_id'))"></el-input>
					<div v-else-if="$check_field('get','employee_id')">{{form_sub['employee_id']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="员工姓名" prop="employee_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['staff_id'] && $check_field('set','employee_name')) || (!form_sub['staff_id'] && $check_field('add','employee_name'))"></el-input>
				...
				<el-form-item label="联系电话" prop="contact_number">
							  ...
							  v-if="user_group === '管理员' || (form_sub['staff_id'] && $check_field('set','contact_number')) || (!form_sub['staff_id'] && $check_field('add','contact_number'))"></el-input>
