<template>
	<view class="diy_details diy_div_dish_information">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/dish_information/get_obj", {
					dish_information_id:this.query.dish_information_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["dish_information_id"] !==0) {
