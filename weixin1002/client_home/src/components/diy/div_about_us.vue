<template>
	<view class="diy_details diy_div_about_us">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/about_us/get_obj", {
					about_us_id:this.query.about_us_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["about_us_id"] !==0) {
