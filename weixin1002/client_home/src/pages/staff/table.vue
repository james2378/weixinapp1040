<template>
  <view class="page_staff diy_table diy_table_tml" id="staff_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="员工姓名" name="employee_name">
                      <uni-easyinput type="text" v-model="query.employee_name" placeholder="员工姓名" />
                    </uni-forms-item>
                      </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/staff/view?" v-show="user_group == '管理员' || $check_action('/staff/table','add') || $check_action('/staff/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','employee_id')" class="col">
						<view class="view">
                            ...
                            <span>员工编号</span>
								...
								<text>
									{{ o["employee_id"] }}
													...
													<view v-if="0 && $check_field('get','employee_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>员工姓名</span>
                          </view>
                            ...
                            <span>性别</span>
								...
								<text>
									{{ o["gender"] }}
													...
													<view v-if="0 && $check_field('get','position')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>职位</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/staff/table','del') || $check_action('/staff/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/staff/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/staff/table','set') || $check_action('/staff/view','set') || $check_action('/staff/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
