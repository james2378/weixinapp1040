        ...
        <view>
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','employee_id') || ($check_field('add','employee_id') || $check_field('set','employee_id'))" label="员工编号" name="employee_id">
                            <uni-easyinput type="text" v-model="form['employee_id']" v-if="user_group === '管理员' || (form['staff_id'] && $check_field('set','employee_id')) || (!form['staff_id'] && $check_field('add','employee_id'))" :disabled="disabledObj['employee_id_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','employee_id')">
                  {{ form['employee_id'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','employee_name') || ($check_field('add','employee_name') || $check_field('set','employee_name'))" label="员工姓名" name="employee_name">
                            <uni-easyinput type="text" v-model="form['employee_name']" v-if="user_group === '管理员' || (form['staff_id'] && $check_field('set','employee_name')) || (!form['staff_id'] && $check_field('add','employee_name'))" :disabled="disabledObj['employee_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','gender') || ($check_field('add','gender') || $check_field('set','gender'))" label="性别" name="gender">
                  ...
                  v-if="user_group === '管理员' || (form['staff_id'] && $check_field('set','gender')) || (!form['staff_id'] && $check_field('add','gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','position') || ($check_field('add','position') || $check_field('set','position'))" label="职位" name="position">
                            <uni-easyinput type="text" v-model="form['position']" v-if="user_group === '管理员' || (form['staff_id'] && $check_field('set','position')) || (!form['staff_id'] && $check_field('add','position'))" :disabled="disabledObj['position_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','contact_number') || ($check_field('add','contact_number') || $check_field('set','contact_number'))" label="联系电话" name="contact_number">
                            <uni-easyinput type="text" v-model="form['contact_number']" v-if="user_group === '管理员' || (form['staff_id'] && $check_field('set','contact_number')) || (!form['staff_id'] && $check_field('add','contact_number'))" :disabled="disabledObj['contact_number_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      is_password: true,
      field: "staff_id",
      url_add: "~/api/staff/add?",
      url_set: "~/api/staff/set?",
      url_get_obj: "~/api/staff/get_obj?",
      url_upload: "~/api/staff/upload?",
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/staff/upload?'),
