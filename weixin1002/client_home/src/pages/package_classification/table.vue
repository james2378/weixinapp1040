<template>
  <view class="page_package_classification diy_table diy_table_tml" id="package_classification_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/package_classification/view?" v-show="user_group == '管理员' || $check_action('/package_classification/table','add') || $check_action('/package_classification/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/package_classification/table','del') || $check_action('/package_classification/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/package_classification/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/package_classification/table','set') || $check_action('/package_classification/view','set') || $check_action('/package_classification/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
