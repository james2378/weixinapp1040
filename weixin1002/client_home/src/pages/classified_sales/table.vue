<template>
  <view class="page_classified_sales diy_table diy_table_tml" id="classified_sales_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/classified_sales/view?" v-show="user_group == '管理员' || $check_action('/classified_sales/table','add') || $check_action('/classified_sales/view','add')">添加</navigator>
                            ...
                            <span>分类名称</span>
								...
								<text>
									{{ o["classification_name"] }}
													...
													<view v-if="0 && $check_field('get','total_sales_revenue')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>总销售额</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/classified_sales/table','del') || $check_action('/classified_sales/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/classified_sales/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/classified_sales/table','set') || $check_action('/classified_sales/view','set') || $check_action('/classified_sales/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
