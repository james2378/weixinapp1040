<template>
  <view class="page_order_status diy_table diy_table_tml" id="order_status_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/order_status/view?" v-show="user_group == '管理员' || $check_action('/order_status/table','add') || $check_action('/order_status/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','dish_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>菜品名称</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','full_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>姓名</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','record_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>记录时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["record_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','order_status')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>订单状态</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/order_status/table','del') || $check_action('/order_status/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/order_status/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/order_status/table','set') || $check_action('/order_status/view','set') || $check_action('/order_status/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
