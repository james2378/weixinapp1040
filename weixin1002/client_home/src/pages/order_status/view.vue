          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','dish_name') || ($check_field('add','dish_name') || $check_field('set','dish_name'))" label="菜品名称" name="dish_name">
                            <uni-easyinput type="text" v-model="form['dish_name']" v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','dish_name')) || (!form['order_status_id'] && $check_field('add','dish_name'))" :disabled="disabledObj['dish_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','phone_number') || ($check_field('add','phone_number') || $check_field('set','phone_number'))" label="手机号码" name="phone_number">
                            <uni-easyinput type="text" v-model="form['phone_number']" v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','phone_number')) || (!form['order_status_id'] && $check_field('add','phone_number'))" :disabled="disabledObj['phone_number_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','order_status') || ($check_field('add','order_status') || $check_field('set','order_status'))" label="订单状态" name="order_status">
                            <uni-easyinput type="text" v-model="form['order_status']" v-if="user_group === '管理员' || (form['order_status_id'] && $check_field('set','order_status')) || (!form['order_status_id'] && $check_field('add','order_status'))" :disabled="disabledObj['order_status_isDisabled']" />
                <!-- 仅查看 -->
