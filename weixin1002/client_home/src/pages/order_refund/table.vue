<template>
  <view class="page_order_refund diy_table diy_table_tml" id="order_refund_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/order_refund/view?" v-show="user_group == '管理员' || $check_action('/order_refund/table','add') || $check_action('/order_refund/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','application_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>申请时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["application_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','reason_for_application')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>申请原因</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/order_refund/table','del') || $check_action('/order_refund/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/order_refund/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/order_refund/table','set') || $check_action('/order_refund/view','set') || $check_action('/order_refund/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
