<template>
  <view class="page_order_information diy_table diy_table_tml" id="order_information_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="套餐名称" name="package_name">
                      <uni-easyinput type="text" v-model="query.package_name" placeholder="套餐名称" />
                    </uni-forms-item>
                      <uni-forms-item label="套餐类型" name="package_type">
                      <uni-easyinput type="text" v-model="query.package_type" placeholder="套餐类型" />
                    </uni-forms-item>
                                  </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/order_information/view?" v-show="user_group == '管理员' || $check_action('/order_information/table','add') || $check_action('/order_information/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','package_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','flavor')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>口味</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','package_type')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>套餐类型</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','package_price')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>套餐价格</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','order_number')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>订单编号</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','full_name')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>姓名</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','phone_number')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>手机号码</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','purchase_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>购买时间</span>
							</view>
								...
								<span>
									{{ $toTime(o["purchase_time"] ,"yyyy-MM-dd") }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="0 && $check_field('get','annotation_notes')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>标注说明</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/order_information/table','del') || $check_action('/order_information/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/order_information/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/order_information/table','set') || $check_action('/order_information/view','set') || $check_action('/order_information/view','get')" class="btn btn-primary">详情</navigator>
											<a @click="goto_pay(o)" size="mini"  v-if="o.pay_state==='未支付' && $check_pay('/order_information/table')" class='btn btn-primary'>支付</a>
					                    									</view>
			</view>
		</view>
	</view>
          ...
          submit_pay(){
            ...
            this.$post(url,param,(res)=>{
              if(res.result){
                _this.$toast("支付成功");
                setTimeout(()=>{
                  _this.$nav("/pages/order_information/table");
                }, 700);
              }else if(res.error){
