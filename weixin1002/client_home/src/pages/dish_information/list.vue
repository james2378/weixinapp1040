<template>
	<view class="page_dish_information diy_list diy_list_page div_list_tml" id="dish_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
															<uni-search-bar placeholder="搜索商家名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'merchant_name')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
							...
							<view class="diy_title" v-if="true">
								...
								<text>
									{{ o["flavor"] }}
													...
													<view v-if="0 && $check_field('get','raw_material')" class="col">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>原料</span>
							</view>
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator class="btn btn-primary" :url="'./details?dish_information_id=' + o['dish_information_id']">查看详情</navigator>
					</view>
				</view>
			</view>
		</view>
