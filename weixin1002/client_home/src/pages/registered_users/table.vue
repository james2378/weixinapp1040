          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    <uni-forms-item label="姓名" name="full_name">
                      <uni-easyinput type="text" v-model="query.full_name" placeholder="姓名" />
                    </uni-forms-item>
                  </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/registered_users/view?" v-show="user_group == '管理员' || $check_action('/registered_users/table','add') || $check_action('/registered_users/view','add')">添加</navigator>
                            ...
                            <span>用户编号</span>
								...
								<text>
									{{ o["user_number"] }}
													...
													<view v-if="0 && $check_field('get','full_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>姓名</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/registered_users/table','del') || $check_action('/registered_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/registered_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/registered_users/table','set') || $check_action('/registered_users/view','set') || $check_action('/registered_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
