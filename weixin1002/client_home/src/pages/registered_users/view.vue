          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','user_number') || ($check_field('add','user_number') || $check_field('set','user_number'))" label="用户编号" name="user_number">
                            <uni-easyinput type="text" v-model="form['user_number']" v-if="user_group === '管理员' || (form['registered_users_id'] && $check_field('set','user_number')) || (!form['registered_users_id'] && $check_field('add','user_number'))" :disabled="disabledObj['user_number_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','user_number')">
                  {{ form['user_number'] }}
                </text>
                          </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','full_name') || ($check_field('add','full_name') || $check_field('set','full_name'))" label="姓名" name="full_name">
                            <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['registered_users_id'] && $check_field('set','full_name')) || (!form['registered_users_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
