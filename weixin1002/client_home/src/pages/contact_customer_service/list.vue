<template>
	<view class="page_contact_customer_service diy_list diy_list_page div_list_tml" id="contact_customer_service_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索客服名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'customer_service_name')">
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?contact_customer_service_id=' + o['contact_customer_service_id']" class="btn btn-primary">查看详情</navigator>
