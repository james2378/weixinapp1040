<template>
  <view id="home" class="home--new">
    ...
    <Card
      class="list_diy"
      title="套餐信息推荐"
      url="/pages/package_information/list"
      :list="list_article"
      v-if="$check_action('/package_information/list', 'get')"
    >
	  <list_package_information :list="list_package_information"></list_package_information>
...
<script>
						...
						import list_package_information from "@/components/diy/list_package_information.vue";
      ...
      this.isAdmin = !this.isAdmin;
		...
		*/
		get_package_information() {
			let url = "~/api/package_information/get_list?";
									
			this.$get(url, {
											}, (json) => {
					if (json.result && json.result.list) {
					console.log("套餐信息" ,json.result.list);
					this.list_package_information = json.result.list;
											this.list_package_information.map((o)=>{
							o["praise_len"];
						});
						this.get_praise(this.list_package_information ,"package_information" ,"33947");
									}
			});
		},
