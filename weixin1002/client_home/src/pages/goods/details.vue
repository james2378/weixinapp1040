					...
					<view>
						<view>
							...
							<!--{if obj.config.details_page == "前详情" && obj.config.cart_page !== "无" }-->
								<div_dish_information v-if="obj.type == '菜品信息'" :obj_goods="obj"></div_dish_information>
							<!--{/if}-->
							<!--{/loop}-->
																			</view>
					</view>
...
<script>
			import div_dish_information from "@/components/diy/div_dish_information.vue";;
