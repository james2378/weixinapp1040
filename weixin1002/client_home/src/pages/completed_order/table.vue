<template>
  <view class="page_completed_order diy_table diy_table_tml" id="completed_order_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="订单编号" name="order_number">
                      <uni-easyinput type="text" v-model="query.order_number" placeholder="订单编号" />
                    </uni-forms-item>
                    <uni-forms-item label="菜品名称" name="dish_name">
                      <uni-easyinput type="text" v-model="query.dish_name" placeholder="菜品名称" />
                    </uni-forms-item>
                            </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/completed_order/view?" v-show="user_group == '管理员' || $check_action('/completed_order/table','add') || $check_action('/completed_order/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="1 && $check_field('get','order_number')" class="col">
						<view class="view">
                            ...
                            <span>订单编号</span>
								...
								<text>
									{{ o["order_number"] }}
													...
													<view v-if="1 && $check_field('get','dish_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>菜品名称</span>
                          </view>
								...
								<text>
									{{ o["dish_name"] }}
													...
													<view v-if="0 && $check_field('get','user_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>用户编号</span>
                          </view>
								...
								<text>
									{{ get_user_user_number(o['user_number']) }}
													...
													<view v-if="1 && $check_field('get','full_name')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>姓名</span>
                          </view>
								...
								<text>
									{{ o["full_name"] }}
													...
													<view v-if="0 && $check_field('get','phone_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>手机号码</span>
                          </view>
								...
								<text>
									{{ o["phone_number"] }}
													...
													<view v-if="0 && $check_field('get','shipping_address')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>收货地址</span>
                          </view>
								...
								<text>
									{{ o["shipping_address"] }}
													...
													<view v-if="0 && $check_field('get','completion_time')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>完成时间</span>
                          </view>
								...
								<text>
									{{ $toTime(o["completion_time"],"yyyy-MM-dd") }}
								</text>
							</view>
										</view>
					</view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/completed_order/table','del') || $check_action('/completed_order/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/completed_order/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/completed_order/table','set') || $check_action('/completed_order/view','set') || $check_action('/completed_order/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/completed_order/get_list?like=0",
				url_del: "~/api/completed_order/del?",
