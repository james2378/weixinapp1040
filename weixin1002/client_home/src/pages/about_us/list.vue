<template>
	<view class="page_about_us diy_list diy_list_page div_list_tml" id="about_us_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索标题" @confirm="search" @cancel="cancel" cancelText="取消"
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?about_us_id=' + o['about_us_id']" class="btn btn-primary">查看详情</navigator>
