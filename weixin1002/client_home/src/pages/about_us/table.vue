<template>
  <view class="page_about_us diy_table diy_table_tml" id="about_us_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/about_us/view?" v-show="user_group == '管理员' || $check_action('/about_us/table','add') || $check_action('/about_us/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','title')">
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','release_time')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>发布时间</span>
							</view>
								...
								<span>
									...
									<view class="col" v-if="0 && $check_field('get','detailed_introduction')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>详情介绍</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/about_us/table','del') || $check_action('/about_us/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/about_us/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/about_us/table','set') || $check_action('/about_us/view','set') || $check_action('/about_us/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
